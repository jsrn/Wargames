...
for i in range(len(characters)):
  try:
		c0 = characters[i-1].islower()
		c1 = characters[i].isupper()
		c2 = characters[i+1].isupper()
		c3 = characters[i+2].isupper()
		c4 = characters[i+3].islower()
		c5 = characters[i+4].isupper()
		c6 = characters[i+5].isupper()
		c7 = characters[i+6].isupper()
		c8 = characters[i+7].islower()

		if c0 and c1 and c2 and c3 and c4 and c5 and c6 and c7 and c8:
			string = characters[i:i+7]
			print string
	except:
		print 'derp'
